(self["webpackChunkVirus_Discovery"] = self["webpackChunkVirus_Discovery"] || []).push([["node_modules_ionic_core_dist_esm_ion-segment_2_entry_js"],{
...
const Segment = class {
  constructor(hostRef) {
    ...
    this.ionSelect = (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionSelect", 7);
   ...
   */
  addRipple(detail) {
    const useRippleEffect = _ionic_global_c74e4951_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('animated', true) && _ionic_global_c74e4951_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('rippleEffect', true);
    if (!useRippleEffect) {
      return;
    }
    const buttons = this.getButtons();
    ...
    const { x, y } = (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_2__.p)(detail.event);
  ...
  render() {
    ...
    return ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.H, { role: "tablist", onClick: this.onClick, class: (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_4__.c)(this.color, {
        [mode]: true,
...
const SegmentButton = class {
  ...
  connectedCallback() {
    ...
    if (segmentEl) {
      this.updateState();
      (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_2__.a)(segmentEl, 'ionSelect', this.updateState);
      (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_2__.a)(segmentEl, 'ionStyle', this.updateStyle);
    }
  }
  disconnectedCallback() {
    const segmentEl = this.segmentEl;
    if (segmentEl) {
      (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_2__.b)(segmentEl, 'ionSelect', this.updateState);
      (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_2__.b)(segmentEl, 'ionStyle', this.updateStyle);
      this.segmentEl = null;
    }
  }
  componentWillLoad() {
    this.inheritedAttributes = Object.assign({}, (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_2__.j)(this.el, ['aria-label']));
  }
  get hasLabel() {
