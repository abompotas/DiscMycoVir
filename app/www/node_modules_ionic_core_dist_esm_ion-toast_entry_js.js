(self["webpackChunkVirus_Discovery"] = self["webpackChunkVirus_Discovery"] || []).push([["node_modules_ionic_core_dist_esm_ion-toast_entry_js"],{
...
/* harmony import */ var _index_c4b11676_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index-c4b11676.js */ 1651);
...
/* harmony import */ var _helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./helpers-3b390e48.js */ 1572);
...
/* harmony import */ var _index_33ffec25_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index-33ffec25.js */ 7857);
/*!
 * (C) Ionic http://ionicframework.com - MIT License
 */
...
const Toast = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionToastDidPresent", 7);
    this.willPresent = (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionToastWillPresent", 7);
    this.willDismiss = (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionToastWillDismiss", 7);
    this.didDismiss = (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionToastDidDismiss", 7);
     ...
     */
    this.duration = _ionic_global_c74e4951_js__WEBPACK_IMPORTED_MODULE_1__.c.getNumber('toastDuration', 0);
    /**
   ...
   */
  async present() {
    await (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_4__.d)(this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, this.position);
    if (this.duration > 0) {
  ...
  async callButtonHandler(button) {
    if (button === null || button === void 0 ? void 0 : button.handler) {
      ...
      try {
        const rtn = await (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_4__.s)(button.handler);
        if (rtn === false) {
  ...
  renderButtons(buttons, side) {
    ...
    return ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: buttonGroupsClasses }, buttons.map((b) => ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "button", class: buttonClass(b), tabIndex: 0, onClick: () => this.buttonClick(b), part: "button" }, (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "toast-button-inner" }, b.icon && ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-icon", { icon: b.icon, slot: b.text === undefined ? 'icon-only' : undefined, class: "toast-button-icon" })), b.text), mode === 'md' && ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-ripple-effect", { type: b.icon !== undefined && b.text === undefined ? 'unbounded' : 'bounded' })))))));
  }
  renderToastMessage() {
    const { customHTMLEnabled, message } = this;
    if (customHTMLEnabled) {
      return (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "toast-message", part: "message", innerHTML: (0,_config_d4f612d2_js__WEBPACK_IMPORTED_MODULE_2__.a)(message) });
    }
    return ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "toast-message", part: "message" }, message));
  }
  render() {
    ...
    return ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.H, Object.assign({ "aria-live": "polite", "aria-atomic": "true", role: role, tabindex: "-1" }, this.htmlAttributes, { style: {
        zIndex: `${60000 + this.overlayIndex}`,
      }, class: (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_5__.c)(this.color, Object.assign(Object.assign({ [mode]: true }, (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_5__.g)(this.cssClass)), { 'overlay-hidden': true, 'toast-translucent': this.translucent })), onIonToastWillDismiss: this.dispatchCancelHandler }), (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: wrapperClass }, (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "toast-container", part: "container" }, this.renderButtons(startButtons, 'start'), this.icon !== undefined && ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-icon", { class: "toast-icon", part: "icon", icon: this.icon, lazy: false, "aria-hidden": "true" })), (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "toast-content" }, this.header !== undefined && ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "toast-header", part: "header" }, this.header)), this.message !== undefined && this.renderToastMessage()), this.renderButtons(endButtons, 'end')))));
  }
  get el() { return (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.i)(this); }
};
const buttonClass = (button) => {
  return Object.assign({ 'toast-button': true, 'toast-button-icon-only': button.icon !== undefined && button.text === undefined, [`toast-button-${button.role}`]: button.role !== undefined, 'ion-focusable': true, 'ion-activatable': true }, (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_5__.g)(button.cssClass));
};
Toast.style = {
  ios: toastIosCss,
  md: toastMdCss
