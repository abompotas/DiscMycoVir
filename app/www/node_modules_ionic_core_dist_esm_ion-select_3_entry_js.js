(self["webpackChunkVirus_Discovery"] = self["webpackChunkVirus_Discovery"] || []).push([["node_modules_ionic_core_dist_esm_ion-select_3_entry_js"],{
...
const Select = class {
  constructor(hostRef) {
    ...
    this.ionDismiss = (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionDismiss", 7);
  ...
  async open(event) {
    ...
    if (this.interface === 'popover') {
      ...
      if (selectedItem) {
        (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_2__.f)(selectedItem);
        /**
  ...
  async openPopover(ev) {
    ...
    return _overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_3__.c.create(popoverOpts);
  }
  async openActionSheet() {
    const mode = (0,_ionic_global_c74e4951_js__WEBPACK_IMPORTED_MODULE_1__.b)(this);
    const interfaceOptions = this.interfaceOptions;
    const actionSheetOpts = Object.assign(Object.assign({ mode }, interfaceOptions), { buttons: this.createActionSheetButtons(this.childOpts, this.value), cssClass: ['select-action-sheet', interfaceOptions.cssClass] });
    return _overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_3__.b.create(actionSheetOpts);
  }
  async openAlert() {
    ...
    return _overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_3__.a.create(alertOpts);
  }
  /**
  ...
  getLabel() {
    return (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_2__.k)(this.el);
  }
  hasValue() {
    return this.getText() !== '';
  }
  ...
  render() {
    ...
    const mode = (0,_ionic_global_c74e4951_js__WEBPACK_IMPORTED_MODULE_1__.b)(this);
    const { labelText, labelId } = (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_2__.d)(el, inputId);
    (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_2__.e)(true, el, name, parseValue(value), disabled);
    ...
    return ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.H, { onClick: this.onClick, role: "button", "aria-haspopup": "listbox", "aria-disabled": disabled ? 'true' : null, "aria-label": displayLabel, class: {
        [mode]: true,
        'in-item': (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_4__.h)('ion-item', el),
        'select-disabled': disabled,
        'select-expanded': isExpanded,
      } }, (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { "aria-hidden": "true", class: selectTextClasses, part: textPart }, selectText), (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "select-icon", role: "presentation", part: "icon" }, (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "select-icon-inner" })), (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", { id: labelId }, displayLabel), (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "button", disabled: disabled, id: inputId, "aria-labelledby": labelId, "aria-haspopup": "listbox", "aria-expanded": `${isExpanded}`, onFocus: this.onFocus, onBlur: this.onBlur, ref: (focusEl) => (this.focusEl = focusEl) })));
  }
...
const SelectOption = class {
  ...
  render() {
    return (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.H, { role: "option", id: this.inputId, class: (0,_ionic_global_c74e4951_js__WEBPACK_IMPORTED_MODULE_1__.b)(this) });
  }
  get el() { return (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.i)(this); }
};
...
const SelectPopover = class {
  ...
  callOptionHandler(ev) {
    ...
    if (option === null || option === void 0 ? void 0 : option.handler) {
      (0,_overlays_58fa8e4d_js__WEBPACK_IMPORTED_MODULE_3__.s)(option.handler, values);
    }
  }
  /**
  ...
  renderCheckboxOptions(options) {
    return options.map((option) => ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-item", { class: (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_4__.g)(option.cssClass) }, (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-checkbox", { slot: "start", value: option.value, disabled: option.disabled, checked: option.checked }), (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-label", null, option.text))));
  }
  renderRadioOptions(options) {
    const checked = options.filter((o) => o.checked).map((o) => o.value)[0];
    return ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-radio-group", { value: checked }, options.map((option) => ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-item", { class: (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_4__.g)(option.cssClass) }, (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-label", null, option.text), (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-radio", { value: option.value, disabled: option.disabled, onClick: (ev) => this.rbClick(ev) }))))));
  }
  render() {
    const { header, message, options, subHeader } = this;
    const hasSubHeaderOrMessage = subHeader !== undefined || message !== undefined;
    return ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.H, { class: (0,_ionic_global_c74e4951_js__WEBPACK_IMPORTED_MODULE_1__.b)(this) }, (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-list", null, header !== undefined && (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-list-header", null, header), hasSubHeaderOrMessage && ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-item", null, (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-label", { class: "ion-text-wrap" }, subHeader !== undefined && (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("h3", null, subHeader), message !== undefined && (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("p", null, message)))), this.renderOptions(options))));
  }
};
SelectPopover.style = {
