(self["webpackChunkVirus_Discovery"] = self["webpackChunkVirus_Discovery"] || []).push([["node_modules_ionic_core_dist_esm_ion-textarea_entry_js"],{
...
const Textarea = class {
  ...
  debounceChanged() {
    this.ionChange = (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_2__.h)(this.ionChange, this.debounce);
  }
  disabledChanged() {
    this.emitStyle();
  }
  ...
  componentWillLoad() {
    this.inheritedAttributes = Object.assign(Object.assign({}, (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_2__.i)(this.el)), (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_2__.j)(this.el, ['data-form-type', 'title', 'tabindex']));
  }
  componentDidLoad() {
    this.runAutoGrow();
  }
  ...
  render() {
    ...
    const label = (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_2__.k)(this.el);
    if (label) {
      label.id = labelId;
    }
    return ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.H, { "aria-disabled": this.disabled ? 'true' : null, class: (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_3__.c)(this.color, {
        [mode]: true,
      }) }, (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "textarea-wrapper", ref: (el) => (this.textareaWrapper = el) }, (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("textarea", Object.assign({ class: "native-textarea", "aria-labelledby": label ? labelId : null, ref: (el) => (this.nativeInput = el), autoCapitalize: this.autocapitalize, autoFocus: this.autofocus, enterKeyHint: this.enterkeyhint, inputMode: this.inputmode, disabled: this.disabled, maxLength: this.maxlength, minLength: this.minlength, name: this.name, placeholder: this.placeholder || '', readOnly: this.readonly, required: this.required, spellcheck: this.spellcheck, cols: this.cols, rows: this.rows, wrap: this.wrap, onInput: this.onInput, onBlur: this.onBlur, onFocus: this.onFocus, onKeyDown: this.onKeyDown }, this.inheritedAttributes), value))));
  }
