(self["webpackChunkVirus_Discovery"] = self["webpackChunkVirus_Discovery"] || []).push([["node_modules_ionic_core_dist_esm_ion-toggle_entry_js"],{
...
/* harmony import */ var _haptic_029a46f6_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./haptic-029a46f6.js */ 3093);
...
const Toggle = class {
  constructor(hostRef) {
     ...
     */
    this.enableOnOffLabels = _ionic_global_c74e4951_js__WEBPACK_IMPORTED_MODULE_2__.c.get('toggleOnOffLabels');
    this.onClick = (ev) => {
      ev.preventDefault();
    ...
    this.getSwitchLabelIcon = (mode, checked) => {
      if (mode === 'md') {
        return checked ? _index_2bcb741c_js__WEBPACK_IMPORTED_MODULE_1__.f : _index_2bcb741c_js__WEBPACK_IMPORTED_MODULE_1__.r;
      }
      return checked ? _index_2bcb741c_js__WEBPACK_IMPORTED_MODULE_1__.r : _index_2bcb741c_js__WEBPACK_IMPORTED_MODULE_1__.g;
    };
  }
  ...
  onMove(detail) {
    if (shouldToggle((0,_dir_e8b767a8_js__WEBPACK_IMPORTED_MODULE_5__.i)(this.el), this.checked, detail.deltaX, -10)) {
      this.checked = !this.checked;
      (0,_haptic_029a46f6_js__WEBPACK_IMPORTED_MODULE_4__.c)();
    }
  }
  onEnd(ev) {
    this.activated = false;
  ...
  renderOnOffSwitchLabels(mode, checked) {
    ...
    return ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("ion-icon", { class: {
  ...
  render() {
    ...
    const { label, labelId, labelText } = (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_3__.d)(el, inputId);
    const value = this.getValue();
    const rtl = (0,_dir_e8b767a8_js__WEBPACK_IMPORTED_MODULE_5__.i)(el) ? 'rtl' : 'ltr';
    (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_3__.e)(true, el, name, checked ? value : '', disabled);
    return ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.H, { onClick: this.onClick, "aria-labelledby": label ? labelId : null, "aria-checked": `${checked}`, "aria-hidden": disabled ? 'true' : null, role: "switch", class: (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_6__.c)(color, {
        [mode]: true,
        ...
        interactive: true,
        [`toggle-${rtl}`]: true,
      }) }, (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "toggle-icon", part: "track" }, enableOnOffLabels &&
      mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "toggle-icon-wrapper" }, (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "toggle-inner", part: "handle" }, enableOnOffLabels && mode === 'md' && this.renderOnOffSwitchLabels(mode, checked)))), (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("label", { htmlFor: inputId }, labelText), (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { type: "checkbox", role: "switch", "aria-checked": `${checked}`, disabled: disabled, id: inputId, onFocus: () => this.onFocus(), onBlur: () => this.onBlur(), ref: (focusEl) => (this.focusEl = focusEl) })));
  }
