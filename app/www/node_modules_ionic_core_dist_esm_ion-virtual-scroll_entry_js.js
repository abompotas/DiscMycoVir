(self["webpackChunkVirus_Discovery"] = self["webpackChunkVirus_Discovery"] || []).push([["node_modules_ionic_core_dist_esm_ion-virtual-scroll_entry_js"],{
...
const VirtualScroll = class {
  ...
  updateVirtualScroll() {
    ...
    (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.f)(this.readVS.bind(this));
    (0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.c)(this.writeVS.bind(this));
  }
  readVS() {
  ...
  updateCellHeight(cell, node) {
    ...
    if (node) {
      (0,_helpers_3b390e48_js__WEBPACK_IMPORTED_MODULE_1__.c)(node, update);
    }
    else {
      update();
    }
  ...
  render() {
    return ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.H, { style: {
        height: `${this.totalHeight}px`,
      } }, this.renderItem && ((0,_index_8e692445_js__WEBPACK_IMPORTED_MODULE_0__.h)(VirtualProxy, { dom: this.virtualDom }, this.virtualDom.map((node) => this.renderVirtualNode(node))))));
  }
